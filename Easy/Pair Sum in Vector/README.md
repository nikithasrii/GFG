<h2><a href="https://www.geeksforgeeks.org/problems/pair-sum-in-vector/1?page=1&category=STL&sortBy=accuracy">Pair Sum in Vector</a></h2><h3>Difficulty Level : Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px"><em>Pairs and vectors can be used together to achieve some amazing results.</em> Here we will learn to use a vector that holds pairs.</span><br>
